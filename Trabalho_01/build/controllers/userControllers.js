...
var JWT_SECRET = process.env.JWT_SECRET || "your_jwt_secret"; // Replace with an environment variable in production
// Register a new user
var register = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, userRepository, existingUser, hashedPassword, user, error_1;
...
var login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, userRepository, user, isPasswordValid, token, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, username = _a.username, password = _a.password;
